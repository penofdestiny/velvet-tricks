...
execute as @a[tag=tasobot.combat,tag=!tasobot.pvp] at @s if entity @n[type=#monsters,distance=..2] run function vlvtrm:tasobot/combat/dodge
...
execute as @a[tag=tasobot.pvp] at @s if entity @p[tag=!tasobot,tag=!tasobot.ignore,distance=..2] run function vlvtrm:tasobot/combat/dodge