...
execute if entity @p[tag=tasobot.following,distance=..3] run motion @s[predicate=vlvtrm:flying] set 0 0 0
execute if entity @p[tag=tasobot.following,distance=4..] run motion @s[predicate=vlvtrm:flying] forward 1.25
